...
poses.push({ 
				id: 5,
				name: 'Dandayamana Janushirasana ', 
				full_name: 'Standing head to knee pose', 
				description: 'Ardha Chandrasana with Pada Hastasana', 
				body_benefits: [
								'Good for lungs and respiratory system',
								'Helps high blood pressure',
...
poses.push({ 
				id: 6,
				name: 'Dandayamana Dhanurasana ', 
				full_name: 'Standing bow pulling pose', 
				description: 'Ardha Chandrasana with Pada Hastasana', 
				body_benefits: [
								'Good for lungs and respiratory system',
								'Helps high blood pressure',
...
poses.push({ 
				...
				full_name: 'Dandayamana Bibhaktapada Paschimottanasana', 
				description: 'Ardha Chandrasana with Pada Hastasana', 
				body_benefits: [
								'Good for lungs and respiratory system',
								'Helps high blood pressure',
...
poses.push({ 
				...
				full_name: 'Dandayamana Bibhaktapada Janushirasana', 
				description: 'Ardha Chandrasana with Pada Hastasana', 
				body_benefits: [
								'Good for lungs and respiratory system',
								'Helps high blood pressure',
...
poses.push({ 
				id: 18,
				name: 'Poorna Salabhasana', 
				full_name: 'Full locust pose', 
				description: 'Ardha Chandrasana with Pada Hastasana', 
				body_benefits: [
								'Good for lungs and respiratory system',
								'Helps high blood pressure',
...
poses.push({ 
				id: 21,
				name: 'Ardha Kurmasana', 
				full_name: 'Half tortoise pose', 
				description: 'Ardha Chandrasana with Pada Hastasana', 
				body_benefits: [
								'Good for lungs and respiratory system',
								'Helps high blood pressure',
...
poses.push({ 
				id: 24,
				name: 'Head to knee pose with intense stretching posture', 
				full_name: 'Utkatasana', 
				description: 'Janushirasana with Paschimottanasana', 
				body_benefits: [
								'Good for lungs and respiratory system',
								'Helps high blood pressure',
								'Exercises nervous, respiratory and circulatory systems'
...
poses.push({ 
				...
				full_name: 'Ardha Matsyendrasana', 
				description: 'Ardha Chandrasana with Pada Hastasana', 
				body_benefits: [
								'Good for lungs and respiratory system',
								'Helps high blood pressure',
...
poses.push({ 
				...
				full_name: 'Kapalbhati in Vajrasana', 
				description: 'Ardha Chandrasana with Pada Hastasana', 
				body_benefits: [
								'Good for lungs and respiratory system',
								'Helps high blood pressure',
